...
papers_2010$titlerank <- order(papers_2010$title_length)
papers_2010$citesrank <- order(papers_2010$cites)
```
...
get_tau_jrn_year <- function(data, jrn, yr){
  ...
  jrn_yr$titlerank <- order(jrn_yr$title_length)
  jrn_yr$citesrank <- order(jrn_yr$cites)
